...
var k = 0, i, j;
/*
Бір1, екі2, үш3, төрт4, бес5, алты6, жеті7, сегіз8, тоғыз9, он10, жиырма20, отыз30, қырық40, елу50, алпыс60, жетпіс70, сексен80, тоқсан90, жүз100, екі жүз200, үш жүз300, төрт жүз400, бес жүз500, алты жүз600, жеті жүз700, сегіз жүз800, тоғыз жүс900, мың 1000
*/
N = ["", "бір", "екі", "үш", "төрт", "бес", "алты", "жеті", "сегіз", "тоғыз",
...
var R = new Array("бүтін", "бүтін", "бүтін", "бүтін", "бүтін", "бүтін", "бүтін", "бүтін", "бүтін", "бүтін");
var K = new Array(" ", " ", " ", " ", " ", " ", " ", " ", " ", " ");
